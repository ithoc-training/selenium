...
public class RegistrationTest {
    ...
    public void registerSuccessfully() {
        ...
        Assertions.assertEquals("http://localhost:8080/?registered=true", currentUrl);

        WebElement messageElement = driver.findElement(By.className("message-body"));
        Assertions.assertEquals("You are now registered. Unfortnuately, there is no login yet...", messageElement.getText());
    }
